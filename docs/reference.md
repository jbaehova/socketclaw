# SocketClaw reference

Detailed installation, operation, and development notes.
...
The light-theme screenshots used in the main README are tracked. Other captures
